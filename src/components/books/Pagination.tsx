      ...
      if (
        ...
        pages.push(
          <button
            ...
            className={`w-9 h-9 text-[#CCC] text-sm font-normal leading-5 cursor-pointer bg-white rounded-md ${
              currentPage === i ? "text-[#6B047C]" : ""
            }`}
          >
            {i}
          </button>,
        ...
        pages.push(
          <div
            key={i}
            className="w-9 h-9 text-[#CCC] text-sm font-normal leading-5 bg-white rounded-[46px] flex items-center justify-center"
          >
            …
          </div>,
        );
  ...
  return (
    <div className="flex justify-center items-center gap-2 mt-5">
      <button
        ...
        className="flex justify-center items-center border cursor-pointer bg-white p-2 rounded-md border-solid border-[#B3B3B3] disabled:opacity-50"
      >
        <svg
          width="21"
          height="20"
